...
基于源码的系统性技术文档集，涵盖 Linux 内核、Zephyr RTOS、Docker、Rust、Go、Python、AI 视觉、Windows 等多个领域。

## 📊 文档统计

- **256 篇**深度解析文档
- **9 大领域**：Linux 内核 / Linux 网络 / Zephyr RTOS / Docker 容器 / Rust / AI 视觉 / Go / Python / Windows
...
| ⚡ [Zephyr RTOS](zephyr-overview.html) | 39 篇 | 内核、调度、内存、同步、IPC、定时器、中断、设备模型、驱动、PM、网络、蓝牙、构建、调试、安全、zbus、SMP、文件系统、工作队列、USB、LLEXT、mcumgr、Modem、DFU、传感、CAN、LoRaWAN、Modbus、RTIO、POSIX、输入、统计、Settings、随机数、Retention、看门狗、网络管理 |
...
| 🐍 Python | 15 篇 | asyncio、FastAPI、Pydantic、SQLAlchemy、测试、性能、NumPy 可视化 |
...
├── mermaid.min.js        # Mermaid 图表渲染库（本地）
├── AGENTS.md             # 文档生成规范
├── README.md             # 本文件
...
- **JavaScript** — ES6+、IntersectionObserver、localStorage、Prism.js、Mermaid.js
- **图表** — Mermaid.js（本地加载，支持架构图、状态图、流程图、时序图）
- **无外部依赖** — 纯原生实现，无需构建工具
